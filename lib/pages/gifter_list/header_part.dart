      ...
      children: [
        SearchBar(
          ...
          onChanged: (searchName) {
            ...
            print(searchProvider.filteredData.length);
          },
                ...
                children: [
                  DropDown(
                      ...
                      onValueChanged: (selectedValue){
                        if(dropDownValue.selectedGiftType == null){
                  ...
                  DropDown(
                      ...
                      onValueChanged: (selectedValue){
                        if(dropDownValue.selectedGender == null){
                      ...
                      itemBuilder: (context, index){
                          return Consumer<UpdateProvider>(
                            builder: (context, value, child) {
                              return InfoCard(
                                  cardOnTap: () {
                                    value.setUpdatedGiftType(searchProvider.filteredData[index].giftType);
                                    value.setUpdatedGenderValue(searchProvider.filteredData[index].gender);
                                    value.setEnable();
